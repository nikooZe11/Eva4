...
const ClientsAdd = () => {
    ...
    const save = async (event) => {
        ...
        var {clientName, role} = document.forms[0];
        var errors = "";
        errors += (clientName.value) < 0 ? "El descuento por precio no puede superar la mitad del unitario.\n": "";
        errors += (role.value) < 0 ? "El descuento por descuento no puede superar el 50%.\n": "";
        if(errors.length > 0){
                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="role" id="role" className="form-control" required />
                                    </div>
                                </div>
                            </div>
